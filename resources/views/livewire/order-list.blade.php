<div>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    訂單管理
                    <input class="border-solid border border-gray-300 p-2 " type="text" placeholder="姓名/ig/電話"
                        value="{{$keyword}}" wire:model="keyword">
                    <x-jet-button class="ml-2" wire:click="searchKeywordPage">
                        搜尋
                    </x-jet-button>
                ...
                <div class="flex items-center px-4 py-3 text-right sm:px-6">
                    ...
                    <x-jet-secondary-button class="ml-2" wire:click="downloadFile">
                        匯出
    ...
    <x-jet-dialog-modal wire:model="showingStatusModal">
        ...
        <x-slot name="footer">
            @if($modal_status == 'draft' || $modal_status == 'submitted' )
            <x-jet-button class="ml-2" wire:click.prevent="changeStatus" wire:loading.attr="disabled">
                {{$actBtnName}}
            </x-jet-button>
            <x-jet-danger-button class="ml-2" wire:click.prevent="cancelStatus" wire:loading.attr="disabled">
                取消訂單
            </x-jet-danger-button>
            @endif
